...
;;;;; rainbow-delimiters
   ...
   `(rainbow-delimiters-depth-2-face ((t (:foreground ,hc-zenburn-green+2))))
   `(rainbow-delimiters-depth-3-face ((t (:foreground ,hc-zenburn-yellow-2))))
   `(rainbow-delimiters-depth-4-face ((t (:foreground ,hc-zenburn-red-1))))
   `(rainbow-delimiters-depth-5-face ((t (:foreground ,hc-zenburn-magenta))))
   `(rainbow-delimiters-depth-6-face ((t (:foreground ,hc-zenburn-blue+1))))
   `(rainbow-delimiters-depth-7-face ((t (:foreground ,hc-zenburn-orange))))
   ...
   `(rainbow-delimiters-depth-10-face ((t (:foreground ,hc-zenburn-cyan))))
